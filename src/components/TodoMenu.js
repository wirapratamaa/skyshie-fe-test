...
const TodoMenu = ({ titleActivity, buttonTitle, addNew }) => {
  return (
    <div className="flex flex-row justify-between items-center mt-10 md:mx-52 mx-5">
      <ActivityTitle title={titleActivity} dataCy={"activity-title"} />
      <ButtonAction dataCy={"activity-add-button"} onClick={addNew}>
        <span>
